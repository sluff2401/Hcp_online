...
def event_list(request, periodsought='current'):
    ...
    return render(request, 'events/list.html', {'events': events_augmented, 'periodsought':periodsought, 'user_can_post_events': user_can_post_events, 'is_authenticated':is_authenticated, 'user_can_edit_any_event': user_can_edit_any_event})
